...
output_base_dir = '0926_results_other_'
...
df_clusters = split_source(K=K, # positive integer: number of clusters
                 ...
                 row_idx=train_sample, # a list of int, row indices of data in use (in metadata)
